		...
		$.jqPaginator('#pagination', {
	        ...
	        onPageChange: function (num, type) {
	        	$.ajax({
		   			...
		   			url: "foreendServlet",
		   			dataType:'json',
		   			data: {type: 'goods', curPage: num, pageSize: pageSize, searchKey: keyword, isOnSale: ""},
		   			success: function(data, status){
		   				console.info(data);
		   				totalPages  = Math.ceil(data.total/pageSize);//计算出总共页数
		   				$("#teacherList").empty();
		   				$.each(data.goods, function(i, obj){
		   					var onsale = '<div class="community-item-sum">价格：￥'+obj.g_price+'</div>';
		   					if( obj.g_isonsale == 1)
		   						onsale = '<div class="community-item-sum"><strong style="color:#DC143C">特价：￥'+obj.g_onsaleprice+'</strong></div>'+
